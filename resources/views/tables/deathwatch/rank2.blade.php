<h3>Rank 2 Deathwatch Advances</h3>
<table  class="table table-striped">
    ...
    <tbody>
        <tr>
            <td><a href="#" data-toggle="popoverload" data-type="skillgroups" data-placement="auto" data-by="name">Ciphers</a> (<a href="#" data-toggle="popoverload" data-type="skills" data-placement="auto" data-by="name">Xenos Markings</a>) +10</td><td>400</td><td>Skill</td><td>Ciphers (Xenos Markings)</td>
        </tr>                
        <tr>             
        ...
        <tr>             
            <td><a href="#" data-toggle="popoverload" data-type="skills" data-placement="auto" data-by="name">Sleight of Hand</a> +10</td><td>400</td><td>Skill</td><td>Sleight of Hand</td>      
        </tr>                
        <tr>             
        ...
        <tr>             
            <td><a href="#" data-toggle="popoverload" data-type="talents" data-placement="auto" data-by="name">Hatred</a> (Tyranids)</td><td>500</td><td>Talent</td><td>—</td>         
        </tr>     
    </tbody>    
 </table>