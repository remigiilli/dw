...
class Speciality extends Model
{
    ...
    {
        return $this->belongsToMany('App\Skill', 'speciality_talent_advance', 'speciality_id', 'talent_id')->withPivot(['cost', 'rank', 'talent_option_id'])->leftJoin('talent_options', 'talent_options.id', '=', 'speciality_talent_advance.talent_option_id');
    }        
}
